...
# Varian *-photo.html adalah FILE TURUNAN dari induknya. Regenerate dulu supaya
# tidak pernah basi setelah file induk diedit. Hanya untuk folder script ini.
if [[ "$TARGET_DIR" == "$SCRIPT_DIR" && -f "$SCRIPT_DIR/make-photo-variants.py" ]]; then
